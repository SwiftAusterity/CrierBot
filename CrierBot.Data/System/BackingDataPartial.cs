...
namespace NetMud.Data.System
{
    ...
    /// </summary>
    public abstract class BackingDataPartial : SerializableDataPartial, IStoredData
    {
        /// <summary>
        ...
        public virtual IStoredData Create()
        {
        ...
        /// <returns></returns>
        public int CompareTo(IStoredData other)
        {
            if (other != null)
            {
                try
        ...
        public bool Equals(IStoredData other)
        {
            if (other != default(IStoredData))
            {
                try
                {
        ...
        {
            IEnumerable<IStoredData> allOfMe = BackingDataCache.GetAll().Where(bdc => bdc.GetType() == this.GetType());
