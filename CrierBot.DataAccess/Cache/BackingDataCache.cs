...
namespace NetMud.DataAccess.Cache
{
    ...
    public static class BackingDataCache
    {
        ...
        public static void Add<T>(T objectToCache) where T : IStoredData
        {
            var entityToCache = (IStoredData)objectToCache;
        ...
        public static IEnumerable<T> GetMany<T>(IEnumerable<long> ids) where T : IStoredData
        {
        ...
        public static IEnumerable<IStoredData> GetAll()
        {
            return BackingCache.GetAll<IStoredData>();
        }
        ...
        public static T GetByName<T>(string name) where T : IStoredData
        {
        ...
        /// <param name="key">the key it was cached with</param>
        /// <returns>the entity requested</returns>
        public static T Get<T>(BackingDataCacheKey key) where T : IStoredData
        {
            return BackingCache.Get<T>(key);
        }
        ...
        /// <returns>the entity requested</returns>
        public static T Get<T>(long id) where T : IStoredData
        {
